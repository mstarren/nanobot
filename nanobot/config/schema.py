...
class ToolsConfig(Base):
    ...
    webui_allow_remote_workspace: bool = Field(
        default=False,
        validation_alias=AliasChoices(
            "webuiAllowRemoteWorkspace",
            "webui_allow_remote_workspace",
        ),
    )  # allow non-local WebUI clients to switch the project workspace (opt-in for remote setups; env NANOBOT_TOOLS__WEBUI_ALLOW_REMOTE_WORKSPACE)
